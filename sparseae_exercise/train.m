...
%disp('program paused, please press enter to continue');
%pause;
...
disp('Use this to visually compare the gradients side by side');
%disp([numgrad grad]); 

% Compare numerically computed gradients with the ones obtained from backpropagation
%diff = norm(numgrad-grad)/norm(numgrad+grad);
disp('In our implementation, these values are usually less than 1e-9');
